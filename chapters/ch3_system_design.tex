...
\textbf{Design Decision:} Define 12 structured action types organized in 6 families (Table~\ref{tab:actions}), with a hybrid extraction pipeline (deterministic keyword matching with LLM fallback) and phase-gated validation.
