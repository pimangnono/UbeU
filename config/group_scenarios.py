...
Discuss with your team and reach a consensus on the plan.""",
    ...
    phases=[
        GroupScenarioPhase(
            ...
            cues=["resource_constraints", "conflicting_priorities"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            name="EXPLORATION",
            ...
            cues=["preference_expression", "tradeoff_comparison"],
            target_traits=["C", "A", "E"],
        ),
        GroupScenarioPhase(
            name="CONFLICT",
...
Discuss creative ideas and converge on a recommendation.""",
    ...
    phases=[
        ...
        GroupScenarioPhase(
            ...
            cues=["option_generation", "novelty"],
            target_traits=["O", "E"],
        ),
        GroupScenarioPhase(
            name="EVALUATION",
            ...
            cues=["tradeoff_comparison", "feasibility_check"],
            target_traits=["C", "O"],
        ),
        GroupScenarioPhase(
            name="DEFENSE",
...
Time pressure: you have 30 minutes before the client call.""",
    ...
    phases=[
        ...
        GroupScenarioPhase(
            ...
            cues=["plan_under_pressure", "owner_deadline_dependency"],
            target_traits=["C", "E"],
        ),
        GroupScenarioPhase(
            name="STRESS_TEST",
...
There is time to plan, and the client has not escalated.""",
    ...
    phases=[
        GroupScenarioPhase(
            ...
            cues=["issue_discovery", "planning_window"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            name="INITIAL_REACTION",
            ...
            cues=["measured_response", "collaboration"],
            target_traits=["A", "E"],
        ),
        GroupScenarioPhase(
            name="PROBLEM_SOLVING",
            ...
            cues=["structured_planning", "owner_deadline_dependency"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            name="STRESS_TEST",
            ...
            cues=["risk_review", "clarification"],
            target_traits=["N", "C"],
        ),
        GroupScenarioPhase(
            name="CLOSING",
...
Help integrate Riley while maintaining team momentum.""",
    ...
    phases=[
        GroupScenarioPhase(
            ...
            cues=["inclusion", "rapport_building"],
            target_traits=["A", "E"],
        ),
        GroupScenarioPhase(
            ...
            cues=["knowledge_transfer", "clarity"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            ...
            cues=["role_conflict", "negotiation"],
            target_traits=["A", "O"],
        ),
        GroupScenarioPhase(
            name="RESOLUTION",
...
There is no single correct answer; creative reframing is encouraged.""",
    ...
    phases=[
        GroupScenarioPhase(
            ...
            cues=["ambiguity", "problem_reframing"],
            target_traits=["O", "E"],
        ),
        GroupScenarioPhase(
            name="ALTERNATIVES",
        ...
        GroupScenarioPhase(
            ...
            cues=["commitment", "experiment_design"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            name="REVISION",
            ...
            cues=["criticism", "reframe_request"],
            target_traits=["O", "A", "N"],
        ),
    ],
)
...
Precision, sequencing, and accountability matter.""",
    ...
    phases=[
        ...
        GroupScenarioPhase(
            ...
            cues=["option_generation", "sequencing"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            name="DECISION",
            ...
            cues=["owner_deadline_dependency", "commitment"],
            target_traits=["C", "A"],
        ),
        GroupScenarioPhase(
            name="REVISION",
